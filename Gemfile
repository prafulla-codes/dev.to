...
group :test do
  ...
  gem "database_cleaner-active_record", "~> 2.0.1", require: false # Strategies for cleaning databases using ActiveRecord. Can be used to ensure a clean state for testing.
